...
There were two major axis of measurements and here is a scatterplot @fig-measurement-scatterplot.

![Scatterplot of the two major measurements.](../figures/eda_scatter_plot.png){#fig-measurement-scatterplot}


As shown in @fig-pearson-corr-matrix, size features are strongly correlated. 
...
Here is the bar plot of our features based on their importance (magnitude) @fig-coefs-barplot.
