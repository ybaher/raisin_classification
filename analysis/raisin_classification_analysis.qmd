...
![Scatterplot of the two major measurements.]("ADD PATH HERE"){#fig-measurement-scatterplot}
...
![Pearson correlation matrix of each numerical feature.]("ADD PATH HERE"){#fig-pearson-corr-matrix}
...
We can see that the dataset is quite balanced, as shown in @fig-logreg-conf-matrix which  indicates that the model correctly predicts more kecimen raisins than besni. We may improve this model with more samples, hyperparameter optimization, and feature engineering.
